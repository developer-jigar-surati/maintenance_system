            ...
            elements: [{
                ...
                type: "hbox", widths: ["115px",
                    ...
                    children: [{
                        ...
                        onChange: function () {
                            var a = this.getDialog(), b = a.getContentElement("info", "cmbValue"),
                                ...
                                a = a.getContentElement("info", "txtOptValue"), d = g(this);
                            i(b, d);
                        ...
                        commit: function (a) {
                            var b = this.getDialog(), e = l(this), d = l(b.getContentElement("info", "cmbValue")),
                    ...
                    type: "vbox", children: [{
                        ...
                        items: [],
                        onChange: function () {
                            var a = this.getDialog(), b = a.getContentElement("info", "cmbName"),
                                e = a.getContentElement("info", "txtOptName"),
                                a = a.getContentElement("info", "txtOptValue"), d = g(this);
                            i(b, d);
                    ...
                    type: "vbox", padding: 5, children: [{
                        ...
                        style: "width:100%;",
                        onClick: function () {
                            var a = this.getDialog(), b = a.getContentElement("info", "txtOptName"),
                                e = a.getContentElement("info", "txtOptValue"),
                                d = a.getContentElement("info", "cmbName"), a = a.getContentElement("info",
                                "cmbValue"), c = g(d);
